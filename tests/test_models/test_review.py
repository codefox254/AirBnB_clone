#!/usr/bin/python3
"""
Module for unit tests related to the Review class.
"""
import os
import unittest
...
class TestReviewInstantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Review] (987654)", review_str)
        self.assertIn("'id': '987654'", review_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        review = Review(id="987", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(review.id, "987")
