#!/usr/bin/python3
"""
Module for unit tests related to the User class.
"""
import os
import unittest
...
class TestUserToDict(unittest.TestCase):
    """
    Tests the to_dict method of the User class.
    """
...
class TestUserInstantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[User] (777779)", user1_str)
        self.assertIn("'id': '777779'", user1_str)
