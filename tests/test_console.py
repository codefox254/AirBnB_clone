...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_object(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("show BaseModel {}".format(obj_id)))
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_object(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            obj_id = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("destroy BaseModel {}".format(obj_id)))
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("show BaseModel {}".format(obj_id)))
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_value(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("update BaseModel 12345 name"))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_object(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            obj_id = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("update BaseModel {} name John".format(obj_id)))
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("show BaseModel {}".format(obj_id)))
            self.assertIn("John", output.getvalue().strip())
...
class TestHBNBCommand_count(unittest.TestCase):
    ...
    def test_count_objects(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertIn("4", output.getvalue().strip())
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for testing update from the HBNB command interpreter"""
    ...
    def test_update_invalid_id(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("update BaseModel 123456"))
            self.assertEqual(correct, output.getvalue().strip())
    ...
    def test_update_missing_attribute_value(self):
        correct = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("update BaseModel 123456 name"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_update_valid_arguments(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("update BaseModel 123456 name John"))
            self.assertIn("[BaseModel] (123456) {'id': '123456', 'name': 'John'}", output.getvalue().strip()
